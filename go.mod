module github.com/verygoodsecurity/terraform-provider-vgs

go 1.19

replace github.com/verygoodsecurity/vgs-api-client-go => /Users/nsokil/IdeaProjects/vgs-api-client-go
...
require (
	...
	github.com/verygoodsecurity/vgs-api-client-go v0.2.5
)
